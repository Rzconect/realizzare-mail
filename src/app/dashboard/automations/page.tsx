  ...
  return (
    <div className="space-y-6 pb-12 font-sans text-slate-800 animate-fadeIn">
      ...
      {showCustomTriggerModal && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-fadeIn">
          <div className="relative w-full max-w-2xl bg-white border border-slate-200 rounded-3xl shadow-2xl overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-6 pb-4 border-b border-slate-100 bg-slate-50/50">
              <div>
                <h3 className="text-sm font-extrabold text-slate-800 flex items-center gap-2">
                  ...
                  Gatilho Personalizado Avan�ado
                </h3>
              ...
              <button
                type="button"
                onClick={() => setShowCustomTriggerModal(false)}
            ...
            <div className="p-4 border-t border-slate-100 flex justify-end gap-2 bg-slate-50/50">
              ...
              <button
                type="button"
                onClick={() => {
                  setNewFlowTrigger("Personalizado (Regra Configuradada)");
